...
// Introducción
const animatedLoads = $("animatedLoads");
for(let i=0;i<7;i++){const el=document.createElement("i");el.style.setProperty("--x",i);animatedLoads.appendChild(el)}
let introAnimating=false;
$("animateBtn").addEventListener("click",()=>{
  introAnimating=!introAnimating;
  animatedLoads.classList.toggle("running",introAnimating);
  $("forceColumn").classList.toggle("active",introAnimating);
